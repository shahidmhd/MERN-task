  ...
  import React, { useEffect, useState } from 'react'
   ...
   function Side() {
    ...
    useEffect(() => {
      ...
      sideBar.style.transform = isOpen ? "translateX(0px)" : "translateX(-260px)";
  ...
  id="closeSideBar"
  className={`h-10 w-10 bg-gray-800 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer text-white ${isOpen ? '' : 'visible'}`}
  onClick={handleSidebarToggle}
>
